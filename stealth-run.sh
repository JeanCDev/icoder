#!/bin/bash
echo "=== Chattiq - Invisible Edition (No Paywall) ==="
echo
...
mkdir -p ~/Library/Application\ Support/chattiq-v1/temp
mkdir -p ~/Library/Application\ Support/chattiq-v1/cache
mkdir -p ~/Library/Application\ Support/chattiq-v1/screenshots
mkdir -p ~/Library/Application\ Support/chattiq-v1/extra_screenshots
