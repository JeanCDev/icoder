...
// Register the chattiq protocol
if (process.platform === "darwin") {
  app.setAsDefaultProtocolClient("chattiq")
} else {
  app.setAsDefaultProtocolClient("chattiq", process.execPath, [
...
async function initializeApp() {
  try {
    ...
    const appDataPath = path.join(app.getPath('appData'), 'chattiq-v1')
